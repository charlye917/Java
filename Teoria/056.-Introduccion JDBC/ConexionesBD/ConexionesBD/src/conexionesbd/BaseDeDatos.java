...
public class BaseDeDatos {
    ...
    public static void ConexionPostgres(){
         ...
         try{
            ...
            conexion.close();
             ...
             System.out.println("Error al conectarse a la base de datos postgres");
                System.out.println(ex);
         }
    }
    ...
    public static void ConexionSQLServer(){
         ...
         try{
            ...
            System.out.println("Error al conectarse a la base de datos SQLServer");
            System.out.println(ex);
        }
     }
}
