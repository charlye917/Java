...
public class EstudianteJDBC {
    ...
    private final String SQL_SELECT = "SELECT estudiante_id, nombre, apellido_paterno, fecha_nacimiento FROM estudiante";
    
    public int insert(int estudiante_id, String nombre, String apellido_paterno, String fecha_nacimiento){
    ...
    public int update(int estudiante_id, String nombre, String apellido_paterno){
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
